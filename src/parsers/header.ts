...
const extraPlayerList6102 = new Parser() // structure introduced in 1.32.0.5
    .int8('preVars1')
    .buffer('pre', { length: 2 })
    .int8('playerId')
    .skip(1)
...
const extraPlayerList6103 = new Parser() // changes from 1.32.0.6, just before launch
    .int8('preVars1')
    .buffer('pre', { length: 2 })
    .int8('playerId')
    .skip(1)
...
const extraPlayerList133 = new Parser() // changes from 1.33 PTR
    .int8('preVars1')
    .buffer('pre', { length: 2 })
    .int8('playerId')
    .skip(1)
...
const extraPlayerList20 = new Parser() // changes from 2.0
    .int8('preVars1')
    .buffer('pre', { length: 2 })
    .int8('playerId')
    .skip(1)
